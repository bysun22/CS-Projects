...
public class Part3Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (count < 2000000) {
            ...
            //int capacity = gen.nextInt(11) + 20;
            index = 0;
            time = 0;
            ...
            //for (int j = 0; j < gen.nextInt(2) + 2; j++) {
...
/*
            ...
            for (int j = 0; j < temp.length; j++) {
                if(temp[j] == null){
                    ...
                    System.out.println(temp[j].getName() + " |T: " + temp[j].getOrderDeliveryTime() + "| " + temp[j].getPosInQueue());
                }
            }
