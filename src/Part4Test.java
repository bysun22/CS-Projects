...
public class Part4Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while ((!customers.isEmpty() || !inQueue.isEmpty()) && flag) {
            ...
            /*
            System.out.println();
            for (int j = 0; j < model.getOrderList().getOrderList().length; j++) {
                if(model.getOrderList().getOrderList()[j] == null){
                    System.out.println("null");
                    break;
                } else {
                    System.out.println(model.getOrderList().getOrderList()[j].getName() + " |T: "
                            + model.getOrderList().getOrderList()[j].getOrderDeliveryTime() + "| "
                            + model.getOrderList().getOrderList()[j].getPosInQueue() + "[" + model.getOrderList().getNumOrders() + "]");
                }
            }
            System.out.println();
        ...
        if (model.getOrdersDelayed() + model.getOrdersCanceled() + model.getOrdersOnTime() != capacity) {
            System.out.println("Orders Delayed " + model.getOrdersDelayed());
            System.out.println("Orders Canceled " + model.getOrdersCanceled());
            System.out.println("Orders OnTime " + model.getOrdersOnTime());
